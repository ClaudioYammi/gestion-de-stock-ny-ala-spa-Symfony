 ...
 */
final class Version20240619111435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD COLUMN reference_produit VARCHAR(50) DEFAULT NULL');
    }
