...
function addRow(event) {
    ...
    var prixunitaireventeCell = document.createElement("td");
    ...
    produitSelect.addEventListener('change', function() {
        ...
        var pricesellInput = prixunitaireventeCell.querySelector('.prixunitairevente-input');
    ...
    prixunitaireventeCell.innerHTML = '<input type="text"  name="prixunitairevente[]" class="prixunitairevente-input form-control">';
    ...
    newRow.appendChild(prixunitaireventeCell);
...
const inputPrix = row.querySelector("input[name='prixunitairevente[]']");
...
console.log(inputProduit)
    try {
        ...
        inputPrix.setAttribute('name',"prixunitairevente-" + index + "");
...
function updateTotal() {
    ...
    rows.forEach(function(row) {
        try {
            ...
            var unitpricesellInput = row.querySelector(".prixunitairevente-input");
